...
//   const { params, saveParams, call } = useDevice()

//   const bleConnected = ble.status === 'connected'
//   const athenaConnected = Object.keys(params).length > 0
...
//       await saveParams(update as any)
//     },
//     [bleConnected, saveParams],
//   )
...
//           {bleOnly && <BleBadge />}
//           <Toggle value={!!(params as Record<string, any>)[paramKey]} onChange={(v) => saveParams({ [paramKey]: v })} disabled={disabled} />
//         </div>
//       </Row>
//     )
//   }
...
//         param: {
//           label: key,
//           type: getParamType(params[key as DeviceParamKey]),
//           description: '',
