---
title: AsiusPilot - Openpilot Fork with Remote Streaming and Joystick
description: Enhanced openpilot fork with remote video streaming, joystick control, and remote params editing. Easy one-click installation.
---

# AsiusPilot

Enhanced [openpilot](https://github.com/asiusai/openpilot) fork with remote streaming, joystick control, and features not available in stock openpilot.
...
3. Enter: `installer.asius.ai`

**Custom branches:** Use `installer.asius.ai/USERNAME/BRANCH` to install from `github.com/USERNAME/openpilot/tree/BRANCH`. Defaults to `asiusai/master`.
