...
class PolyLine extends capnp_ts_1.Struct {
  ...
  getPoints() {
    return capnp_ts_1.Struct.getList(0, PolyLine._Points, this)
  }
  hasPoints() {
    return !capnp_ts_1.Struct.isNull(capnp_ts_1.Struct.getPointer(0, this))
  }
  initPoints(length) {
    return capnp_ts_1.Struct.initList(0, PolyLine._Points, length, this)
  }
  setPoints(value) {
    capnp_ts_1.Struct.copyFrom(value, capnp_ts_1.Struct.getPointer(0, this))
  }
  toString() {
    return 'PolyLine_' + super.toString()
  }
}
...
class Lane_LaneBoundary extends capnp_ts_1.Struct {
  ...
  disownPolyLine() {
    return capnp_ts_1.Struct.disown(this.getPolyLine())
  }
  getPolyLine() {
    return capnp_ts_1.Struct.getStruct(0, PolyLine, this)
  }
  hasPolyLine() {
    return !capnp_ts_1.Struct.isNull(capnp_ts_1.Struct.getPointer(0, this))
  }
  initPolyLine() {
    return capnp_ts_1.Struct.initStructAt(0, PolyLine, this)
  }
  setPolyLine(value) {
    capnp_ts_1.Struct.copyFrom(value, capnp_ts_1.Struct.getPointer(0, this))
  }
  ...
  setStartHeading(value) {
    capnp_ts_1.Struct.setFloat32(0, value, this)
  }
  toString() {
    return 'Lane_LaneBoundary_' + super.toString()
  }
}
...
class TileSummary extends capnp_ts_1.Struct {
  ...
  toString() {
    return 'TileSummary_' + super.toString()
  }
}
...
class MapTile extends capnp_ts_1.Struct {
  ...
  disownSummary() {
    return capnp_ts_1.Struct.disown(this.getSummary())
  }
  getSummary() {
    return capnp_ts_1.Struct.getStruct(0, TileSummary, this)
  }
  hasSummary() {
    return !capnp_ts_1.Struct.isNull(capnp_ts_1.Struct.getPointer(0, this))
  }
  initSummary() {
    return capnp_ts_1.Struct.initStructAt(0, TileSummary, this)
  }
  setSummary(value) {
    capnp_ts_1.Struct.copyFrom(value, capnp_ts_1.Struct.getPointer(0, this))
  }
  ...
  disownLanes() {
    return capnp_ts_1.Struct.disown(this.getLanes())
  }
  getLanes() {
    return capnp_ts_1.Struct.getList(1, MapTile._Lanes, this)
  }
  hasLanes() {
    return !capnp_ts_1.Struct.isNull(capnp_ts_1.Struct.getPointer(1, this))
  }
  initLanes(length) {
    return capnp_ts_1.Struct.initList(1, MapTile._Lanes, length, this)
  }
  setLanes(value) {
    capnp_ts_1.Struct.copyFrom(value, capnp_ts_1.Struct.getPointer(1, this))
  }
  toString() {
    return 'MapTile_' + super.toString()
  }
}
